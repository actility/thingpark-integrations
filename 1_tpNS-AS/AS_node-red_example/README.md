# Node-RED Application Server Example
...
In order to try these Node-RED examples you need a Node-RED server that you can install either on your own machine locally or use it on IBM Cloud.  
