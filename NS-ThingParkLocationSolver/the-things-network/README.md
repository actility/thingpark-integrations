...
Set up your Node RED server and App as it is described in the root of this repo [here](https://github.com/actility/thingpark-integrations/blob/main/Node-RED-quick-start.md).  
